...
<template>
                    ...
                    <v-container fuild>
                        ...
                        <v-row>
                            <v-col cols="12" md="4" class="justify-center">
                                <v-list-subheader style="text-align: left;" >Loại tài khoản</v-list-subheader>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-radio-group
    ...
    >
        ...
        >
            ...
            <v-sheet style="text-align: center;" class="pa-4">
        ...
        methods:{
            ...
            createNewAccount(){
                ...
                let interValTime = setInterval(()=>{
                    this.timeOTP = utilController.subStractMinutes(secondStart)
                    secondStart-=1
                    if(secondStart == 0) clearInterval(interValTime)
                },1000)
            },
            setData(){
