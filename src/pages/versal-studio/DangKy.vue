    ...
    <div class="bg-card">
        <v-container>
            <v-card class="mx-auto" max-width="800">
                <v-card-title style="text-align: center;">ĐĂNG KÝ TÀI KHOẢN</v-card-title>
                ...
                <v-card-actions class="justify-center">
                    <v-btn style="background-color: green; color: white; margin-bottom: 20px;">ĐĂNG KÝ TÀI KHOẢN</v-btn>
                </v-card-actions>
            </v-card>
        </v-container>
        <Footer></Footer>
