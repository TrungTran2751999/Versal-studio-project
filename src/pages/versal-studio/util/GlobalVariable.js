...
export const API = {
    ADMIN:{
        ...
        tinTuc:{
            ...
            duyetBai:  `${domainApi}/api/admin/tin-tuc/duyet-bai`,
        },
        tournament:{
            theLoaiGame:{
...
export let listBaiViet = [
    ...
    },
    {
        ...
        name:"TEC 2024: Sự kiện Công nghệ – Esports – Cộng đồng hấp dẫn dành cho sinh viên do Versal Esports tổ chức",
        isFake:true,
        tenLoaiTinTuc:"SỰ KIỆN ESPORTS",
        updatedAt:"2024-12-27 00:00:00"
    },
]