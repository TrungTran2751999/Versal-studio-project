...
<template>
 ...
 Gửi lời chào đến toàn bộ người chơi Liên Quân Mobile trong khu vực Đà Nẵng. Nhân dịp chào đón các bạn sinh viên, học sinh trở lại học tập sau một khoảng thời gian dài n...
        ...
        <v-card>
            ...
            <v-card-actions class="justify-center">
                <Carousel v-bind="config" style="width: 1000px;">
        ...
        <!-- -------------------- -->
        <v-card style="background-color: #2a2a2a;">
            <v-card-actions>
                <v-row>
                    <v-col cols="12" sm="6">
                        <div style="color: wheat; font-size: 20px;">VERSAL-STUDIO</div>
                    </v-col>
                    <v-col cols="12" sm="6">
                        <div style="color: wheat">VERSAL-STUDIO</div>
                    </v-col>
                </v-row>
            </v-card-actions>
        </v-card>
